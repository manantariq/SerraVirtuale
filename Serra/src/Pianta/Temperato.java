 ...
 * @author Manan
 */
public class Temperato extends Pianta{

    public Temperato(String specie, int età, CategoriaPianta categoria, StatoSalute salute,int[][] coordinate,int dim,float altezza) {
        this.specie = specie;
        this.età = età;
        ...
        this.Min_temp_ottimale = 14;
        this.Max_temp_ottimale = 28;
