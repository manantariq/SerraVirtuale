 ...
 * @author Manan
 */
public class Tropicale extends Pianta{
    
    public Tropicale(String specie,int età,CategoriaPianta categoria,StatoSalute salute,int[][] coordinate,int dim,float altezza){
        this.specie = specie;
        this.età = età;
        ...
        this.Min_temp_ottimale = 25;
        this.Max_temp_ottimale = 50;
